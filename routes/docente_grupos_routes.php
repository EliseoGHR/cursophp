...
Route::group(['prefix' => 'docentes_grupos', 'middleware' => 'auth_docentes'], function () {
    ...
    Route::put('/edit/{id}', [DocenteGrupoController::class, 'update'])->name('docentes_grupos.update');
    Route::get('/delete/{id}', [DocenteGrupoController::class, 'delete'])->name('docentes_grupos.delete');
    Route::delete('/delete/{id}', [DocenteGrupoController::class, 'destroy'])->name('docentes_grupos.destroy');
});
