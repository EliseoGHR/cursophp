...
Route::group(['prefix' => 'asistencias', 'middleware' => 'auth_docentes'], function () {
    ...
    Route::get('/asistencia', [AsistenciaController::class, 'asistencia'])->name('asistencias.marcarAsistencia');
    Route::post('/asistencia', [AsistenciaController::class, 'asistenciaStore'])->name('asistencias.asistenciaStore');
